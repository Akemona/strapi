...
If you’ve been using `strapi-provider-upload-cloudinary` and have migrated to V4 (or if you want to), you can find the equivalent and updated version of this package at this [URL](https://github.com/akemona/strapi/tree/master/packages/providers/upload-cloudinary) and with the following name on NPM: `@strapi/provider-upload-cloudinary`.

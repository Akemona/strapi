...
If you’ve been using `strapi-provider-email-mailgun` and have migrated to V4 (or if you want to), you can find the equivalent and updated version of this package at this [URL](https://github.com/akemona/strapi/tree/master/packages/providers/email-mailgun) and with the following name on NPM: `@strapi/provider-email-mailgun`.

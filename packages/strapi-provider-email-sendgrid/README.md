...
If you’ve been using `strapi-provider-email-sendgrid` and have migrated to V4 (or if you want to), you can find the equivalent and updated version of this package at this [URL](https://github.com/akemona/strapi/tree/master/packages/providers/email-sendgrid) and with the following name on NPM: `@strapi/provider-email-sendgrid`.
